...
# Exploring Bonding Entropy and Magnetism in Graphene Nanostructures

Recently, two studies have offered fresh perspectives on the magnetic properties of graphene nanostructures, combining insights from condensed matter physics, chemistry, and materials science.


## 1. Bonding entropy model for carbon nanostructures (Journal of Chemical Physics, 2025)

Building on BEM, the second paper develops a  general **bonding entropy model**.  

Highlights include:
- Extending the entropy framework to **irregular topologies**, such as graphene with pentagons or defects.  
- Connecting electronic-state uncertainty with **energetic stability** in a unified manner.  
- Providing a path toward a general theory that can apply to both perfect lattices and real-world imperfect structures.  

## 2. Bonding entropy model for magnetic graphene nanoflakes (Physical Review B)
